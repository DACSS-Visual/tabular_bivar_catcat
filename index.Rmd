...
barStacked3 + labs(fill="precinct") + theme_minimal()
```
...
bars5  = base5 + geom_bar( stat = "identity" ) + theme_minimal()
barsFacet = bars5 + facet_grid(~ daytime)  # X
# trick
